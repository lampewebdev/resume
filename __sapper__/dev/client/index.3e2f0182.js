...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 134, 6, 2667);
			attr(div1, "class", "job");
			add_location(div1, file, 135, 6, 2701);
			attr(div2, "class", "profile p-2 svelte-114zil2");
			add_location(div2, file, 133, 4, 2635);
			attr(img, "class", "profile-picture svelte-114zil2");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 137, 4, 2753);
			attr(li0, "class", "svelte-114zil2");
			add_location(li0, file, 139, 6, 2868);
			add_location(span0, file, 142, 10, 2908);
			add_location(p0, file, 141, 8, 2894);
			attr(li1, "class", "svelte-114zil2");
			add_location(li1, file, 140, 6, 2881);
			add_location(span1, file, 148, 10, 3012);
			add_location(p1, file, 147, 8, 2998);
			attr(li2, "class", "svelte-114zil2");
			add_location(li2, file, 146, 6, 2985);
			add_location(span2, file, 154, 10, 3124);
			add_location(p2, file, 153, 8, 3110);
			attr(li3, "class", "svelte-114zil2");
			add_location(li3, file, 152, 6, 3097);
			add_location(span3, file, 160, 10, 3226);
			add_location(p3, file, 159, 8, 3212);
			attr(li4, "class", "svelte-114zil2");
			add_location(li4, file, 158, 6, 3199);
			add_location(span4, file, 166, 10, 3334);
			add_location(p4, file, 165, 8, 3320);
			attr(li5, "class", "svelte-114zil2");
			add_location(li5, file, 164, 6, 3307);
			attr(ul, "class", "profile-information svelte-114zil2");
			add_location(ul, file, 138, 4, 2829);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 132, 2, 2573);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 131, 0, 2548);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
