...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 127, 6, 2615);
			attr(div1, "class", "job");
			add_location(div1, file, 128, 6, 2649);
			attr(div2, "class", "profile p-2 svelte-1299x7s");
			add_location(div2, file, 126, 4, 2583);
			attr(img, "class", "profile-picture svelte-1299x7s");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 130, 4, 2701);
			attr(li0, "class", "svelte-1299x7s");
			add_location(li0, file, 132, 6, 2816);
			add_location(span0, file, 135, 10, 2856);
			add_location(p0, file, 134, 8, 2842);
			attr(li1, "class", "svelte-1299x7s");
			add_location(li1, file, 133, 6, 2829);
			add_location(span1, file, 141, 10, 2960);
			add_location(p1, file, 140, 8, 2946);
			attr(li2, "class", "svelte-1299x7s");
			add_location(li2, file, 139, 6, 2933);
			add_location(span2, file, 147, 10, 3072);
			add_location(p2, file, 146, 8, 3058);
			attr(li3, "class", "svelte-1299x7s");
			add_location(li3, file, 145, 6, 3045);
			add_location(span3, file, 153, 10, 3174);
			add_location(p3, file, 152, 8, 3160);
			attr(li4, "class", "svelte-1299x7s");
			add_location(li4, file, 151, 6, 3147);
			add_location(span4, file, 159, 10, 3282);
			add_location(p4, file, 158, 8, 3268);
			attr(li5, "class", "svelte-1299x7s");
			add_location(li5, file, 157, 6, 3255);
			attr(ul, "class", "profile-information svelte-1299x7s");
			add_location(ul, file, 131, 4, 2777);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 125, 2, 2521);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 124, 0, 2496);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
