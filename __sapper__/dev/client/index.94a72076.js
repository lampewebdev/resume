...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 134, 6, 2849);
			attr(div1, "class", "job");
			add_location(div1, file, 135, 6, 2883);
			attr(div2, "class", "profile p-2 svelte-fc035p");
			add_location(div2, file, 133, 4, 2817);
			attr(img, "class", "profile-picture svelte-fc035p");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 137, 4, 2935);
			attr(li0, "class", "svelte-fc035p");
			add_location(li0, file, 139, 6, 3050);
			add_location(span0, file, 142, 10, 3090);
			add_location(p0, file, 141, 8, 3076);
			attr(li1, "class", "svelte-fc035p");
			add_location(li1, file, 140, 6, 3063);
			add_location(span1, file, 148, 10, 3194);
			add_location(p1, file, 147, 8, 3180);
			attr(li2, "class", "svelte-fc035p");
			add_location(li2, file, 146, 6, 3167);
			add_location(span2, file, 154, 10, 3306);
			add_location(p2, file, 153, 8, 3292);
			attr(li3, "class", "svelte-fc035p");
			add_location(li3, file, 152, 6, 3279);
			add_location(span3, file, 160, 10, 3408);
			add_location(p3, file, 159, 8, 3394);
			attr(li4, "class", "svelte-fc035p");
			add_location(li4, file, 158, 6, 3381);
			add_location(span4, file, 166, 10, 3516);
			add_location(p4, file, 165, 8, 3502);
			attr(li5, "class", "svelte-fc035p");
			add_location(li5, file, 164, 6, 3489);
			attr(ul, "class", "profile-information svelte-fc035p");
			add_location(ul, file, 138, 4, 3011);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 132, 2, 2755);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 131, 0, 2730);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
