...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 134, 6, 2854);
			attr(div1, "class", "job");
			add_location(div1, file, 135, 6, 2888);
			attr(div2, "class", "profile p-2 svelte-bpmqt0");
			add_location(div2, file, 133, 4, 2822);
			attr(img, "class", "profile-picture svelte-bpmqt0");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 137, 4, 2940);
			attr(li0, "class", "svelte-bpmqt0");
			add_location(li0, file, 139, 6, 3055);
			add_location(span0, file, 142, 10, 3095);
			add_location(p0, file, 141, 8, 3081);
			attr(li1, "class", "svelte-bpmqt0");
			add_location(li1, file, 140, 6, 3068);
			add_location(span1, file, 148, 10, 3199);
			add_location(p1, file, 147, 8, 3185);
			attr(li2, "class", "svelte-bpmqt0");
			add_location(li2, file, 146, 6, 3172);
			add_location(span2, file, 154, 10, 3311);
			add_location(p2, file, 153, 8, 3297);
			attr(li3, "class", "svelte-bpmqt0");
			add_location(li3, file, 152, 6, 3284);
			add_location(span3, file, 160, 10, 3413);
			add_location(p3, file, 159, 8, 3399);
			attr(li4, "class", "svelte-bpmqt0");
			add_location(li4, file, 158, 6, 3386);
			add_location(span4, file, 166, 10, 3521);
			add_location(p4, file, 165, 8, 3507);
			attr(li5, "class", "svelte-bpmqt0");
			add_location(li5, file, 164, 6, 3494);
			attr(ul, "class", "profile-information svelte-bpmqt0");
			add_location(ul, file, 138, 4, 3016);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 132, 2, 2760);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 131, 0, 2735);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
