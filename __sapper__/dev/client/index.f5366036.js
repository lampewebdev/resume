...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 124, 6, 2377);
			attr(div1, "class", "job");
			add_location(div1, file, 125, 6, 2411);
			attr(div2, "class", "profile p-2 svelte-6d7non");
			add_location(div2, file, 123, 4, 2345);
			attr(img, "class", "profile-picture svelte-6d7non");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 127, 4, 2463);
			attr(li0, "class", "svelte-6d7non");
			add_location(li0, file, 129, 6, 2578);
			add_location(span0, file, 132, 10, 2618);
			add_location(p0, file, 131, 8, 2604);
			attr(li1, "class", "svelte-6d7non");
			add_location(li1, file, 130, 6, 2591);
			add_location(span1, file, 138, 10, 2722);
			add_location(p1, file, 137, 8, 2708);
			attr(li2, "class", "svelte-6d7non");
			add_location(li2, file, 136, 6, 2695);
			add_location(span2, file, 144, 10, 2834);
			add_location(p2, file, 143, 8, 2820);
			attr(li3, "class", "svelte-6d7non");
			add_location(li3, file, 142, 6, 2807);
			add_location(span3, file, 150, 10, 2936);
			add_location(p3, file, 149, 8, 2922);
			attr(li4, "class", "svelte-6d7non");
			add_location(li4, file, 148, 6, 2909);
			add_location(span4, file, 156, 10, 3044);
			add_location(p4, file, 155, 8, 3030);
			attr(li5, "class", "svelte-6d7non");
			add_location(li5, file, 154, 6, 3017);
			attr(ul, "class", "profile-information svelte-6d7non");
			add_location(ul, file, 128, 4, 2539);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 122, 2, 2283);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 121, 0, 2258);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
