...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 95, 6, 1780);
			attr(div1, "class", "job");
			add_location(div1, file, 96, 6, 1814);
			attr(div2, "class", "profile p-2 svelte-hcut0e");
			add_location(div2, file, 94, 4, 1748);
			attr(img, "class", "profile-picture svelte-hcut0e");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 98, 4, 1866);
			attr(li0, "class", "svelte-hcut0e");
			add_location(li0, file, 100, 6, 1981);
			add_location(span0, file, 103, 10, 2021);
			add_location(p0, file, 102, 8, 2007);
			attr(li1, "class", "svelte-hcut0e");
			add_location(li1, file, 101, 6, 1994);
			add_location(span1, file, 109, 10, 2125);
			add_location(p1, file, 108, 8, 2111);
			attr(li2, "class", "svelte-hcut0e");
			add_location(li2, file, 107, 6, 2098);
			add_location(span2, file, 115, 10, 2237);
			add_location(p2, file, 114, 8, 2223);
			attr(li3, "class", "svelte-hcut0e");
			add_location(li3, file, 113, 6, 2210);
			add_location(span3, file, 121, 10, 2339);
			add_location(p3, file, 120, 8, 2325);
			attr(li4, "class", "svelte-hcut0e");
			add_location(li4, file, 119, 6, 2312);
			add_location(span4, file, 127, 10, 2447);
			add_location(p4, file, 126, 8, 2433);
			attr(li5, "class", "svelte-hcut0e");
			add_location(li5, file, 125, 6, 2420);
			attr(ul, "class", "profile-information svelte-hcut0e");
			add_location(ul, file, 99, 4, 1942);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 93, 2, 1686);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 92, 0, 1661);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
