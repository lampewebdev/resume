...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 117, 6, 2306);
			attr(div1, "class", "job");
			add_location(div1, file, 118, 6, 2340);
			attr(div2, "class", "profile p-2 svelte-imsjrf");
			add_location(div2, file, 116, 4, 2274);
			attr(img, "class", "profile-picture svelte-imsjrf");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 120, 4, 2392);
			attr(li0, "class", "svelte-imsjrf");
			add_location(li0, file, 122, 6, 2507);
			add_location(span0, file, 125, 10, 2547);
			add_location(p0, file, 124, 8, 2533);
			attr(li1, "class", "svelte-imsjrf");
			add_location(li1, file, 123, 6, 2520);
			add_location(span1, file, 131, 10, 2651);
			add_location(p1, file, 130, 8, 2637);
			attr(li2, "class", "svelte-imsjrf");
			add_location(li2, file, 129, 6, 2624);
			add_location(span2, file, 137, 10, 2763);
			add_location(p2, file, 136, 8, 2749);
			attr(li3, "class", "svelte-imsjrf");
			add_location(li3, file, 135, 6, 2736);
			add_location(span3, file, 143, 10, 2865);
			add_location(p3, file, 142, 8, 2851);
			attr(li4, "class", "svelte-imsjrf");
			add_location(li4, file, 141, 6, 2838);
			add_location(span4, file, 149, 10, 2973);
			add_location(p4, file, 148, 8, 2959);
			attr(li5, "class", "svelte-imsjrf");
			add_location(li5, file, 147, 6, 2946);
			attr(ul, "class", "profile-information svelte-imsjrf");
			add_location(ul, file, 121, 4, 2468);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 115, 2, 2212);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 114, 0, 2187);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
