...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 53, 3, 962);
			attr(div1, "class", "job");
			add_location(div1, file, 54, 3, 993);
			attr(div2, "class", "profile p-2 svelte-y9ihrw");
			add_location(div2, file, 52, 2, 933);
			attr(img, "class", "profile-picture svelte-y9ihrw");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 58, 2, 1050);
			attr(li0, "class", "svelte-y9ihrw");
			add_location(li0, file, 60, 3, 1158);
			add_location(span0, file, 64, 5, 1193);
			add_location(p0, file, 63, 4, 1184);
			attr(li1, "class", "svelte-y9ihrw");
			add_location(li1, file, 62, 3, 1175);
			add_location(span1, file, 70, 5, 1273);
			add_location(p1, file, 69, 4, 1264);
			attr(li2, "class", "svelte-y9ihrw");
			add_location(li2, file, 68, 3, 1255);
			add_location(span2, file, 76, 5, 1361);
			add_location(p2, file, 75, 4, 1352);
			attr(li3, "class", "svelte-y9ihrw");
			add_location(li3, file, 74, 3, 1343);
			add_location(span3, file, 82, 5, 1439);
			add_location(p3, file, 81, 4, 1430);
			attr(li4, "class", "svelte-y9ihrw");
			add_location(li4, file, 80, 3, 1421);
			add_location(span4, file, 88, 5, 1523);
			add_location(p4, file, 87, 4, 1514);
			attr(li5, "class", "svelte-y9ihrw");
			add_location(li5, file, 86, 3, 1505);
			attr(ul, "class", "profile-information svelte-y9ihrw");
			add_location(ul, file, 59, 2, 1122);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 51, 1, 873);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 50, 0, 849);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
