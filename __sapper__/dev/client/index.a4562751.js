...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 126, 6, 2585);
			attr(div1, "class", "job");
			add_location(div1, file, 127, 6, 2619);
			attr(div2, "class", "profile p-2 svelte-14f08u5");
			add_location(div2, file, 125, 4, 2553);
			attr(img, "class", "profile-picture svelte-14f08u5");
			attr(img, "src", "profile.jpg");
			attr(img, "alt", "profile picture");
			add_location(img, file, 129, 4, 2671);
			attr(li0, "class", "svelte-14f08u5");
			add_location(li0, file, 131, 6, 2786);
			add_location(span0, file, 134, 10, 2826);
			add_location(p0, file, 133, 8, 2812);
			attr(li1, "class", "svelte-14f08u5");
			add_location(li1, file, 132, 6, 2799);
			add_location(span1, file, 140, 10, 2930);
			add_location(p1, file, 139, 8, 2916);
			attr(li2, "class", "svelte-14f08u5");
			add_location(li2, file, 138, 6, 2903);
			add_location(span2, file, 146, 10, 3042);
			add_location(p2, file, 145, 8, 3028);
			attr(li3, "class", "svelte-14f08u5");
			add_location(li3, file, 144, 6, 3015);
			add_location(span3, file, 152, 10, 3144);
			add_location(p3, file, 151, 8, 3130);
			attr(li4, "class", "svelte-14f08u5");
			add_location(li4, file, 150, 6, 3117);
			add_location(span4, file, 158, 10, 3252);
			add_location(p4, file, 157, 8, 3238);
			attr(li5, "class", "svelte-14f08u5");
			add_location(li5, file, 156, 6, 3225);
			attr(ul, "class", "profile-information svelte-14f08u5");
			add_location(ul, file, 130, 4, 2747);
			attr(div3, "class", "container mx-auto shadow-xl self-center m-6");
			add_location(div3, file, 124, 2, 2491);
			attr(div4, "class", "flex m-4");
			add_location(div4, file, 123, 0, 2466);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
